...
<ns1:linhas>
<ns1:linha>
{fn:concat('&#xa;numeroProtocolo&#x9;duracao_esb&#x9;timestamp&#x9;telefone&#x9;status')}
{
for $httpSample in $testResults1/ns0:httpSample
	return fn:concat(
		'&#xa;'
		, fn:data($httpSample/ns0:queryString//*:numeroProtocolo)
		, '&#x9;'
		, fn:data($httpSample/@t)
		, '&#x9;'
		, fn:data($httpSample/@ts)
		, '&#x9;'
		, fn:data($httpSample/ns0:responseData//*:telefone)
		, '&#x9;'
		, fn:data($httpSample/ns0:responseData//*:status)
	)
}
{fn:concat('&#xa;')}
